<div class="container-fluid">
	<h1 class="my-4"><span class="fas fa-tools mr-2"></span>Setting Absensi</h1>
	<div class="row mb-4">
		<div class="col-xl-6">
			<div class="card mb-4">
				<div class="card-header">
					<div class="float-right">
						...
						<button class="btn btn-danger" disabled><span class="fas fa-undo-alt mr-1"></span>Reset Setting
							App</button>
						<?php elseif (!empty($dataapp['status_setting'])) : ?>
						<!-- <button id="resetsettingapp" class="btn btn-danger" disabled="" ><span
				...
				<div class="card-body text-center">
					<h3 class="mb-4"><span class="fas fa-fw fa-exclamation-triangle mr-1"></span>Fitur Setting Belum Ada
					</h3>
				...
				<div class="card-body">
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
							<input type="hidden" class="form-control" id="nama_instansi" name="nama_instansi"
								value="<?= $nameinstansiset = (empty($dataapp['nama_instansi'])) ? '[Nama Instansi Belum Disetting]' : $dataapp['nama_instansi']; ?>">
						</div>
					</div>
					<div class="form-group row">
						<!-- <label for="pesan_jumbotron" class="col-sm-4 col-form-label">Pesan Halaman Depan</label> -->
						<div class="col-sm-8">
							<input type="hidden" class="form-control" id="pesan_jumbotron" name="pesan_jumbotron"
								value="<?= $jumbotronset = (empty($dataapp['jumbotron_lead_set'])) ? '[Ubah Kalimat Pada Teks Ini Disetting Aplikasi]' : $dataapp['jumbotron_lead_set']; ?>">
						</div>
					</div>
					<div class="form-group row">
						<!-- <label for="nama_app_absen" class="col-sm-4 col-form-label">Nama Aplikasi Absensi</label> -->
						<div class="col-sm-8">
							<input type="hidden" class="form-control" id="nama_app_absen" name="nama_app_absen"
								value="<?= $nameapp = (empty($dataapp['nama_app_absensi'])) ? 'Absensi Online' : $dataapp['nama_app_absensi']; ?>">
						</div>
					</div>
					<div class="form-group row">
						...
						<div class="col-sm-8">
							<div class="input-group">
								<input type="text"  class="form-control" id="timezone_absen" name="timezone_absen"
									value="<?= $nameapp = (empty($dataapp['timezone'])) ? 'Asia/Jakarta' : $dataapp['timezone']; ?>">
						...
						<div class="col-sm-8">
							<div class="input-group">
								<input type="text" class="form-control" id="absen_mulai" name="absen_mulai"
									value="<?= $nameapp = (empty($dataapp['absen_mulai'])) ? '06:00:00' : $dataapp['absen_mulai']; ?>">
								<div class="input-group-append">
									<button class="input-group-text" type="button" id="setTimebtn" tabindex="-1">Set
										Current Time</button>
								</div>
							</div>
						</div>
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
							<div class="custom-control custom-checkbox">
								<?= form_checkbox('lokasi_absensi', 1, ($dataapp['maps_use'] == 1) ? true : false, 'id="lokasi_absensi" class="custom-control-input"'); ?><!-- <label
									class="custom-control-label" for="lokasi_absensi">Menggunakan Maps</label> --></div>
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<div class="row">
								<div class="col-sm-3">
									<img src="<?= (empty($dataapp['logo_instansi'])) ? base_url('assets/img/clock-image.png') : (($dataapp['logo_instansi'] == 'default-logo.png') ? base_url('assets/img/clock-image.png') : base_url('storage/setting/' . $dataapp['logo_instansi'])); ?>"
										class="img-thumbnail">
								</div>
								<div class="col-sm-9">
                                ...
                                <div class="col-sm-12 text-center mt-3">
                                        <button type="submit" class="btn btn-success" id="settingapp-btn"><span class="fas fa-pen mr-1"></span>Edit</button>
                                    </div>
                                </div>
							</div>
						</div>
