    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-striped table-hover" id="datapegawai" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>Nama Pegawai</th>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group row">
                    <label for="username_pegawai" class="col-sm-4 col-form-label">NIP Username</label>
                    <div class="col-sm-8">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        ...
                        <small class="text-success">Pastikan sama dengan NIP username</small>
                    </div>
                </div>
                <div class="form-group row">
